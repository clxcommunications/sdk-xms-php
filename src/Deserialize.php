...
class Deserialize
{
     ...
     * `MtTextSmsBatchCreate` object is returned, if the value is
     * `mt_binary` then an `MtBinarySmsBatchCreate` object is
     ...
     * fields.
     *
     * @param [] $fields the fields as generated by `json_decode`
     *
     ...
     * @param [] $fields the fields as generated by `json_decode`
     *
     * @return Api\GroupResponse the created group response
     */
